      ...
      <div class="hero-header-11-content">
        <div class="container">
          <nav class="navbar navbar-expand-xl navbar-light py-sm-2 py-1 px-0">
            <a class="navbar-brand editContent" href="index.html">Teacher Login Portal</a>
  ...
  <main>
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Login</h2>
          <h2 class="text-center"><b>Please Enter The Valid Username and Password to Enter The Marks of The Students</b></h2>
          ...
          <div class="container">
            <div class="footers14-bottom text-center">
              <div class="copyright mt-1">
                <p>© 2021 All Rights Reserved | Design by Anwesha Banerjee</p>
              </div>
            </div>
          </div>
        </div>
